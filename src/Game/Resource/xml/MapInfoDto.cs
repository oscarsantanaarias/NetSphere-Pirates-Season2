...
namespace Netsphere.Resource.xml
{
    ...
    {
        [XmlElement("map")]
        public MapInfoInfoDto[] map { get; set; }
    }
    ...
    public class MapInfoInfoDto
    {
        ...
        [XmlElement("base")]
        public BaseMapInfoDto Base { get; set; }

        [XmlElement("resourse")]
        public ResourceMapInfoDto resource { get; set; }

        [XmlElement("switch")]
        public SwitchMapInfoDto Switch { get; set; }
    }

    [XmlType(AnonymousType = true)]
    public class BaseMapInfoDto
    {
        [XmlAttribute("map_name_key")]
        public string map_name_key { get; set; }

        [XmlAttribute("mode_number")]
        public int mode_number { get; set; }

        [XmlAttribute("limit_player")]
        public int limit_player { get; set; }

        [XmlAttribute("index_number")]
    ...
    {
        [XmlAttribute("bginfo_path")]
        public string bginfo_path { get; set; }

        [XmlAttribute("previewinfo_path")]
