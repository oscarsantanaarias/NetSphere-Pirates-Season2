...
namespace Netsphere.Network.Message.GameRule
{
    ...
    public class SEventMessageAckMessage: IGameRuleMessage
    {
        ...
        // Season 2 only reads the event and the string. Kept off the wire.
        public ulong AccountId { get; set; }
    ...
    // 21072: contador int + entradas
    [BlubContract]
    public class SSeizeUpdateInfoAckMessage : IGameRuleMessage
    {
        [BlubMember(0, typeof(ArrayWithIntPrefixSerializer))]
        public SeizeInfoDto[] Info { get; set; }

        public SSeizeUpdateInfoAckMessage()
        {
            Info = Array.Empty<SeizeInfoDto>();
        }
    }

    // 21073: contador int + entradas
    [BlubContract]
    public class SSeizeUpdateInfoByIntrudeAckMessage : IGameRuleMessage
    {
        [BlubMember(0, typeof(ArrayWithIntPrefixSerializer))]
        public SeizeIntrudeInfoDto[] Info { get; set; }

        public SSeizeUpdateInfoByIntrudeAckMessage()
        {
            Info = Array.Empty<SeizeIntrudeInfoDto>();
        }
    }

    // 21074: b8,b8
    [BlubContract]
    public class SSeizeFeverTimeAckMessage : IGameRuleMessage
    {
        [BlubMember(0)]
        public ulong Unk1 { get; set; }
    ...
    // 21075: b8,b8
    [BlubContract]
    public class SSeizeGetBuffItemAckMessage : IGameRuleMessage
    {
        [BlubMember(0)]
        public ulong Unk1 { get; set; }
    ...
    // 21076: contador int + entradas
    [BlubContract]
    public class SSeizeDropBuffItemAckMessage : IGameRuleMessage
    {
        [BlubMember(0, typeof(ArrayWithIntPrefixSerializer))]
        public SeizeBuffDropDto[] Items { get; set; }

        public SSeizeDropBuffItemAckMessage()
        {
            Items = Array.Empty<SeizeBuffDropDto>();
        }
    }
}
