...
namespace Netsphere.Network.Message.GameRule
{
    ...
    public class CEventMessageReqMessage : IGameRuleMessage
    {
        ...
        // Season 2 only sends the event and one uint.
        public ulong AccountId { get; set; }
    ...
    // 20045: sin cuerpo
    [BlubContract]
    public class CIntrudeRoundReqMessage : IGameRuleMessage
    {
    }

    // 20046: b4,b1,b4
    [BlubContract]
    public class CLoadingSucceesReqMessage : IGameRuleMessage
    {
    }

    // 20047: b4,b1,b4
    [BlubContract]
    public class CSeizePositionCaptureReqMessage : IGameRuleMessage
    {
        [BlubMember(0)]
        public uint Unk1 { get; set; }
    ...
    // 20048: b8
    [BlubContract]
    public class CSeizeGetBuffItemReqMessage : IGameRuleMessage
    {
        [BlubMember(0)]
        public ulong Unk { get; set; }
    }
    ...
    // 20049: b8
    [BlubContract]
    public class CChangeMasterRequestReqMessage : IGameRuleMessage
    {
        [BlubMember(0)]
        public ulong AccountId { get; set; }
    }
