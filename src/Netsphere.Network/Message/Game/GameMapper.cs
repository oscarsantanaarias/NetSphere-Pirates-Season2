...
namespace Netsphere.Network.Message.Game
{
    internal static class GameMapper
    {
        ...
        static GameMapper()
        {
            ...
            Create<CGameGuardAuthReqMessage>(GameOpCode.CGameGuardAuthReq);
            Create<CHShieldMakeResponseReqMessage>(GameOpCode.CHShieldMakeResponseReq);
            Create<CShoppingBasketActionReqMessage>(GameOpCode.CShoppingBasketActionReq);
            Create<CShoppingBasketDeleteReqMessage>(GameOpCode.CShoppingBasketDeleteReq);
            Create<CRandomShopGetNiceItemReqMessage>(GameOpCode.CRandomShopGetNiceItemReq);
            Create<SGetPlayerInfoAckMessage>(GameOpCode.SGetPlayerInfoAck);
            Create<SGameGuardAuthAckMessage>(GameOpCode.SGameGuardAuthAck);
            Create<SHShieldMakeResponseAckMessage>(GameOpCode.SHShieldMakeResponseAck);
            Create<SFindUserAckMessage>(GameOpCode.SFindUserAck);
            Create<SRoomInfosAckMessage>(GameOpCode.SRoomInfosAck);
            Create<SStartLoadingAckMessage>(GameOpCode.SStartLoadingAck);
            Create<SStartIngameAckMessage>(GameOpCode.SStartIngameAck);
            Create<SEndLoadingAckMessage>(GameOpCode.SEndLoadingAck);
            Create<SShoppingBasketActionAckMessage>(GameOpCode.SShoppingBasketActionAck);
            Create<SShoppingBasketListAckMessage>(GameOpCode.SShoppingBasketListAck);
            Create<SRandomShopUpdateRequestAckMessage>(GameOpCode.SRandomShopUpdateRequestAck);
            Create<SRandomShopRollingStartAckMessage>(GameOpCode.SRandomShopRollingStartAck);
            Create<SRandomShopWhoGetNiceItemAckMessage>(GameOpCode.SRandomShopWhoGetNiceItemAck);
            ...
            Create<SDefaultNickAckMessage>(GameOpCode.SDefaultNickAck);
            Create<SGiveItemResultAckMessage>(GameOpCode.SGiveItemResultAck);
            Create<SRandomShopUpdateCheckAckMessage>(GameOpCode.SRandomShopUpdateCheckAck);
            Create<SRandomShopUpdateInfoAckMessage>(GameOpCode.SRandomShopUpdateInfoAck);
            ...
            Create<CCreateFirstCharacterReqMessage>(GameOpCode.CCreateFirstCharacterReq);
            Create<CRandomShopUpdateCheckReqMessage>(GameOpCode.CRandomShopUpdateCheckReq);
        }
