...
namespace Netsphere.Network.Message.Game
{
    ...
    [BlubContract]
    public class CCreateFirstCharacterReqMessage : IGameMessage
    {
        [BlubMember(0, typeof(StringSerializer))]
        public string Nickname { get; set; }

        [BlubMember(1, typeof(ArrayWithIntPrefixSerializer))]
        public uint[] Costumes { get; set; }

        public CCreateFirstCharacterReqMessage()
        {
            Nickname = "";
            Costumes = Array.Empty<uint>();
        }
    }

    [BlubContract]
    public class CRandomShopUpdateCheckReqMessage : IGameMessage
    {
        [BlubMember(0, typeof(StringSerializer))]
        ...
        public CRandomShopUpdateCheckReqMessage()
        {
            Date = "";
        }
    }
    ...
    // 50025: b4,b4,b4,b4
    [BlubContract]
    public class CGameGuardAuthReqMessage : IGameMessage
    {
        [BlubMember(0)]
        public uint Unk1 { get; set; }
    ...
    // 50026: b2,str
    [BlubContract]
    public class CHShieldMakeResponseReqMessage : IGameMessage
    {
        [BlubMember(0)]
        ...
        public CHShieldMakeResponseReqMessage()
        {
            Unk2 = "";
        }
    }
    ...
    // 50056
    [BlubContract]
    public class CShoppingBasketActionReqMessage : IGameMessage
    {
        [BlubMember(0)]
        public ShoppingBasketItemDto Item { get; set; }

        public CShoppingBasketActionReqMessage()
        {
    ...
    // 50057: u32,u64
    [BlubContract]
    public class CShoppingBasketDeleteReqMessage : IGameMessage
    {
        [BlubMember(0)]
        public uint Unk1 { get; set; }
    ...
    // 50060: b4,b4,b4,b4
    [BlubContract]
    public class CRandomShopGetNiceItemReqMessage : IGameMessage
    {
        [BlubMember(0)]
        public uint Unk1 { get; set; }
