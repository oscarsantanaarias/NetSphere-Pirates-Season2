...
namespace Netsphere.Network.Message.Game
{
    ...
    public class GameMessageFactory : MessageFactory<GameOpCode, IGameMessage>
    {
        ...
        public GameMessageFactory()
        {
            ...
            Register<SDefaultNickAckMessage>(GameOpCode.SDefaultNickAck);
            Register<SGiveItemResultAckMessage>(GameOpCode.SGiveItemResultAck);
            Register<SRandomShopUpdateCheckAckMessage>(GameOpCode.SRandomShopUpdateCheckAck);
            Register<SRandomShopUpdateInfoAckMessage>(GameOpCode.SRandomShopUpdateInfoAck);
            ...
            Register<CQuickJoinReqMessage>(GameOpCode.CQuickJoinReq);
            ...
            Register<CCreateFirstCharacterReqMessage>(GameOpCode.CCreateFirstCharacterReq);
            Register<CRandomShopUpdateCheckReqMessage>(GameOpCode.CRandomShopUpdateCheckReq);
            ...
            Register<CGameGuardAuthReqMessage>(GameOpCode.CGameGuardAuthReq);
            Register<CHShieldMakeResponseReqMessage>(GameOpCode.CHShieldMakeResponseReq);
            Register<CShoppingBasketActionReqMessage>(GameOpCode.CShoppingBasketActionReq);
            Register<CShoppingBasketDeleteReqMessage>(GameOpCode.CShoppingBasketDeleteReq);
            Register<CRandomShopGetNiceItemReqMessage>(GameOpCode.CRandomShopGetNiceItemReq);
            Register<SGetPlayerInfoAckMessage>(GameOpCode.SGetPlayerInfoAck);
            Register<SGameGuardAuthAckMessage>(GameOpCode.SGameGuardAuthAck);
            Register<SHShieldMakeResponseAckMessage>(GameOpCode.SHShieldMakeResponseAck);
            Register<SFindUserAckMessage>(GameOpCode.SFindUserAck);
            Register<SRoomInfosAckMessage>(GameOpCode.SRoomInfosAck);
            Register<SStartLoadingAckMessage>(GameOpCode.SStartLoadingAck);
            Register<SStartIngameAckMessage>(GameOpCode.SStartIngameAck);
            Register<SEndLoadingAckMessage>(GameOpCode.SEndLoadingAck);
            Register<SShoppingBasketActionAckMessage>(GameOpCode.SShoppingBasketActionAck);
            Register<SShoppingBasketListAckMessage>(GameOpCode.SShoppingBasketListAck);
            Register<SRandomShopUpdateRequestAckMessage>(GameOpCode.SRandomShopUpdateRequestAck);
            Register<SRandomShopRollingStartAckMessage>(GameOpCode.SRandomShopRollingStartAck);
            Register<SRandomShopWhoGetNiceItemAckMessage>(GameOpCode.SRandomShopWhoGetNiceItemAck);
        }
    }
}
