...
namespace Netsphere.Network.Message.Chat
{
    ...
    public class ChatMessageFactory : MessageFactory<ChatOpCode, IChatMessage>
    {
        ...
        public ChatMessageFactory()
        {
            ...
            Register<SClubNoticeChangeAckMessage>(ChatOpCode.SClubNoticeChangeAck);
            ...
            Register<CSaveCommunityPermissionReqMessage>(ChatOpCode.CSaveCommunityPermissionReq);
            Register<CSaveOptionBinaryReqMessage>(ChatOpCode.CSaveOptionBinaryReq);
            Register<CUserDataReq2Message>(ChatOpCode.CUserDataReq2);
            Register<SPlayerInfoAckMessage>(ChatOpCode.SPlayerInfoAck);
            Register<SPlayerPosInfoAckMessage>(ChatOpCode.SPlayerPosInfoAck);
            Register<SPlayerInfoListAckMessage>(ChatOpCode.SPlayerInfoListAck);
        }
    }
}
