...
namespace Netsphere.Network.Message.Chat
{
    internal static class ChatMapper
    {
        ...
        static ChatMapper()
        {
            ...
            Create<SClubNoticeChangeAckMessage>(ChatOpCode.SClubNoticeChangeAck);
        ...
        public static void Create<T>(ChatOpCode opCode)
            Create<CSaveCommunityPermissionReqMessage>(ChatOpCode.CSaveCommunityPermissionReq);
            Create<CSaveOptionBinaryReqMessage>(ChatOpCode.CSaveOptionBinaryReq);
            Create<CUserDataReq2Message>(ChatOpCode.CUserDataReq2);
            Create<SPlayerInfoAckMessage>(ChatOpCode.SPlayerInfoAck);
            Create<SPlayerPosInfoAckMessage>(ChatOpCode.SPlayerPosInfoAck);
            Create<SPlayerInfoListAckMessage>(ChatOpCode.SPlayerInfoListAck);
