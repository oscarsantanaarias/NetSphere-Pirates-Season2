...
namespace ProudNet
{
    public class ProudServerPipe : ProudPipe
    {
        ...
        public override async void OnConnected(SessionEventArgs e)
        {
            ...
            Console.WriteLine($"[proudnet] conexion entrante de {remoteEndPoint}, mandando NotifyServerConnectionHint");
            ...
            using (var cts = new CancellationTokenSource(s_timeout))
            {
                ...
                catch (OperationCanceledException)
                {
                    ...
                    Console.WriteLine($"[proudnet] {remoteEndPoint} nunca contesto al hint, se acabo el tiempo del handshake");
